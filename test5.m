...
%%%%%%%%%%%%%%% COMMENTS %%%%%%%%%%%%%
%Removed temporarly step 0, as I am debugging the overall trajectory

%Future modification, make cost function as they do it (means and stuff)
...
Initial_pose = transl(50,0,0)*trotz(pi/2);
Path(:,:,1) = Initial_pose;
