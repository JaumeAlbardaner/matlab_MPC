...
%%%%%%%%%%%%%%% COMMENTS %%%%%%%%%%%%%
%Car strives to get the closest to the center but wiggles way too much.

%Possible solution: Add weight to controls so that they become as 
%  simple as possible.
%ALSO: Must generate cost function
